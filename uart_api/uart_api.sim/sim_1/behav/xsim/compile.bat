...
REM
REM Generated by Vivado on Mon Nov 03 11:40:03 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj uart_api_dc_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj uart_api_dc_tb_vlog.prj -log xvlog.log
