...
HD_PWD='D:/ee_class/uart_api/uart_api.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_dc.tcl -notrace
