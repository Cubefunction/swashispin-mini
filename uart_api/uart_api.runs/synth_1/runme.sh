...
HD_PWD='D:/ee_class/uart_api/uart_api.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_dc.tcl
