...
module dcli
   #(parameter NUM_DC_CHANNEL=24,
     ...
     parameter TOTAL_REGS=DC_SEQ_REGS+DC+CTRL_REGS+
                          LI_SEQ_REGS+LI_CTRL_REGS+
                          LCH_TOTAL_REGS)
    (input  logic i_clk, i_rst,

     // uart registers
     input  logic [0:TOTAL_REGS-1][31:0] i_uart_regs,
    ...
    ****************/
    ...
    for (genvar i = 0; i < NUM_DC_CHANNEL; i++) begin : DC_GEN
        ...
        dc DC (
            ...
            .i_seq_regs({i_uart_regs[DC_SEQ_START:DC_SEQ_END-1], 31'h0, 
                         i_uart_regs[DC_SEQ_END][i]}),

            .i_ctrl_regs({i_uart_regs[DC_CTRL_START:DC_CTRL_END-1], 31'h0, 
                          i_uart_regs[DC_CTRL_END][i]}),
    ...
    ********************/
    ...
    launch #(
        ...
        .i_regs(i_uart_regs[LCH_START:LCH_END]),
